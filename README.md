...
一个基于 WebGL (Three.js) 和计算机视觉 (MediaPipe) 的交互式 3D 圣诞树体验。在原作者的基础上添加相关音效、修复照片飞出屏幕外/看不太清楚，并增加灵敏度调整。
...
* **添加多套音效**: 背景BGM(`bgm.mp3`)、张开手掌音效(`open.mp3`)、握拳音效(`close.mp3`)。支持3套音效方案，可自行在文件内修改。
* **灵敏度调整**: 可以调节张手移动视图时的灵敏度。
